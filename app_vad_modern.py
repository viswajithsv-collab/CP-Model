...
with plot_col1:
    ...
    fig1.add_trace(go.Scatter(x=t, y=results['LVP'], 
                             line=dict(color='#ff006e', width=2),
                             fill='tozeroy', fillcolor='rgba(255,0,110,0.2)',
                             name="LVP"), row=1, col=1)
    
    fig1.add_trace(go.Scatter(x=t, y=results['LVV'], 
                             line=dict(color='#ff4d94', width=2),
                             fill='tozeroy', fillcolor='rgba(255,77,148,0.2)',
                             name="LVV"), row=2, col=1)
...
with plot_col2:
    ...
    fig2.add_trace(go.Scatter(x=t, y=results['RVP'], 
                             line=dict(color='#00d9ff', width=2),
                             fill='tozeroy', fillcolor='rgba(0,217,255,0.2)',
                             name="RVP"), row=1, col=1)
    
    fig2.add_trace(go.Scatter(x=t, y=results['RVV'], 
                             line=dict(color='#66e3ff', width=2),
                             fill='tozeroy', fillcolor='rgba(102,227,255,0.2)',
                             name="RVV"), row=2, col=1)
...
with plot_col4:
    ...
    fig4.add_trace(go.Scatter(x=t, y=results['Psa'], 
                             line=dict(color='#ff6b35', width=2),
                             name="Aortic"))
    fig4.add_trace(go.Scatter(x=t, y=results['Ppa'], 
                             line=dict(color='#00d9ff', width=2),
                             name="Pulmonary"))
...
with plot_col5:
    ...
    fig5.add_trace(go.Scatter(x=t, y=results['Qaov'], line=dict(color='#ff006e', width=2), name="Aortic"))
    fig5.add_trace(go.Scatter(x=t, y=results['Qmv'], line=dict(color='#ff4d94', width=2), name="Mitral"))
    fig5.add_trace(go.Scatter(x=t, y=results['Qpulv'], line=dict(color='#00d9ff', width=2), name="Pulm"))
    fig5.add_trace(go.Scatter(x=t, y=results['Qtv'], line=dict(color='#66e3ff', width=2), name="Tricusp"))
...
with plot_col6:
    ...
    fig6.add_trace(go.Scatter(x=t, y=results['LAP'], 
                             line=dict(color='#ff006e', width=2),
                             name="LA"))
    fig6.add_trace(go.Scatter(x=t, y=results['RAP'], 
                             line=dict(color='#00d9ff', width=2),
                             name="RA"))
